...
data:    vmName                               String        mywebsecuritymanager                                                          
...
[Alert Logic Web Security Manager for Azure](https://docs.alertlogic.com/cloud/microsoft-azure-web-security-manager-premier-iaas-manual.htm)

#### Deployment Parameters:
```
storageAccountName: (Storage account where the Web Security Manager VM will be deployed)
blobContainerName: (Blob container to deploy Web Security Manager)
osDiskVhdUri: (Link to Alert Logic Web Security Manager VHD)
availabilitySetName: (Name of new Web Security Manager Availability Set)
numberOfInstances: (Number of Web Security Manager instances to deploy)
